...
progressoLicoesRouter.get(
  "/progresso-licoes/licao/:licaoId",
  authMiddleware,
  (req, res) => {
    try {
      ...
      // Buscar o progresso do usuário para esta lição
      ...
      if (!progresso) {
        return res.status(404).json({
          ...
          message: "O usuário ainda não iniciou esta lição",
        });
      }
      ...
      return res
        .status(500)
        .json({ error: "Erro ao buscar progresso da lição" });
    }
  }
);
